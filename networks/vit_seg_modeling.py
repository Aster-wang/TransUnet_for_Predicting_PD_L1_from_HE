...
class DecoderBlock(nn.Module):
    def __init__(
        ...
        # self.up = UpSample(spatial_dims=2, scale_factor=2, in_channels=in_channels)
...
class SegmentationHead(nn.Sequential):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=3, upsampling=1):
        ...
        # upsampling = UpSample(spatial_dims=2, scale_factor=upsampling, in_channels=out_channels) if upsampling > 1 else nn.Identity()
